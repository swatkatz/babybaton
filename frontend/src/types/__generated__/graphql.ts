...
export type GetMyFamilyQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyFamilyQuery = { getMyFamily: { __typename: 'Family', id: string, name: string, babyName: string, caregivers: Array<{ __typename: 'Caregiver', id: string, name: string }> } | null };
